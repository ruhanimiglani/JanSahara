  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/women/safety-tips" element={<WomenSafety />} />
        <Route
          path="/women/domestic-violence"
          element={<WomenDomesticViolence />}
        />
        <Route path="/women/ngos" element={<WomenNGOs />} />
        ...
        <Route path="/child-abuse" element={<ChildAbuse />} />
        <Route path="/child-ngos" element={<ChildNGOs />} />
